INSERT INTO USER (ID, USERNAME, PASSWORD, EMAIL, ROLE, SUBSCRIBED, MONTHS_SUBSCRIBED, FREE_TRIAL_AVAILABLE, SUBSCRIPTION_END_DATE)
VALUES (nextval('user_sequence'), 'admin', '$2a$10$r5Me01u6ND9eC8aG17MFY.JeF2XvA6xBmAnQNjAnivHHiClm.aUlq', 'portal@gmail.com', 'ADMIN', true, 0, false, null);
INSERT INTO USER (ID, USERNAME, PASSWORD, EMAIL, ROLE, SUBSCRIBED, MONTHS_SUBSCRIBED, FREE_TRIAL_AVAILABLE, SUBSCRIPTION_END_DATE)
VALUES (nextval('user_sequence'), 'Bob', '$2a$10$ZNYsqenZekWe8rdjOH/sQuFmmeR07MVtO34pRS1sfkx9klS0FYUDK', 'bob@gmail.com', 'USER', false, 0, true, null);
INSERT INTO USER (ID, USERNAME, PASSWORD, EMAIL, ROLE, SUBSCRIBED, MONTHS_SUBSCRIBED, FREE_TRIAL_AVAILABLE, SUBSCRIPTION_END_DATE)
VALUES (nextval('user_sequence'), 'Sofie', '$2a$10$B34UYAqFJQDvSvVnYO7TF.0DaFoHS8wx/IA1YwW2p.bBWjfYmdhPy', 'sofie@gmail.com', 'DESIGNER', true, 2, false, '2022-06-17');
