INSERT INTO USER (ID, USERNAME, DISPLAYNAME, PASSWORD, EMAIL, ROLE, DESIGNER_APPLICATION)
VALUES (nextval('user_sequence'), 'admin', 'admin', '$2a$10$r5Me01u6ND9eC8aG17MFY.JeF2XvA6xBmAnQNjAnivHHiClm.aUlq', 'portal@gmail.com', 'ADMIN', false);
INSERT INTO USER (ID, USERNAME, DISPLAYNAME, PASSWORD, EMAIL, ROLE, DESIGNER_APPLICATION)
VALUES (nextval('user_sequence'), 'Bob', 'Bob', '$2a$10$ZNYsqenZekWe8rdjOH/sQuFmmeR07MVtO34pRS1sfkx9klS0FYUDK', 'bob@gmail.com', 'USER', false);
INSERT INTO USER (ID, USERNAME, DISPLAYNAME, PASSWORD, EMAIL, ROLE, DESIGNER_APPLICATION)
VALUES (nextval('user_sequence'), 'Sofie', 'Sofie', '$2a$10$B34UYAqFJQDvSvVnYO7TF.0DaFoHS8wx/IA1YwW2p.bBWjfYmdhPy', 'sofie@gmail.com', 'DESIGNER', false);
